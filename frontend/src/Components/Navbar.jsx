    ...
    return (
        <div className="Navbar_Top z-20">
            ...
            <ul className="flex  p-4 text-slate-500">
                <li onClick={()=>{navigate("/");setMenu('home')}} className={menu=='home'?'underline p-2':'p-2'}>home</li>
                <li onClick={()=>{navigate("/");setMenu('menu')}} className={menu=='menu'?'underline p-2':'p-2'}>menu</li>
                <li onClick={()=>{navigate("/");setMenu('contact-us')}} className={menu=='contact-us'?'underline p-2':'p-2'}>contact us</li>
            </ul>
